 ...
 * the returned calculationCorrectAnswer
 */
...
function incrementScore() {
    let oldScore = parent(document.getElementById("score").innerText);
...
function incrementWrongAnswer() {
    let oldScore = parent(document.getElementById("incorrect").innerText);
